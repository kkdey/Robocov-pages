...
```{r}
robospan2_df = read.table("/Users/kushaldey/Documents/Robocov-pages/Gene_Sets/Robospan_mean.txt")
dim(robospan2_df)

probospan2_df = read.table("/Users/kushaldey/Documents/Robocov-pages/Gene_Sets/pRobospan_mean.txt")
dim(probospan2_df)

corspan2_df = read.table("/Users/kushaldey/Documents/Robocov-pages/Gene_Sets/Corspan_mean.txt")
dim(corspan2_df)
```
...
```{r}
housekeep = read.table("/Users/kushaldey/Documents/Robocov-pages/Gene_Sets/housekeeping_genes.txt")
head(housekeep)
```
...
```{r}
seg_gtex = read.table("/Users/kushaldey/Documents/Mouse_Humans/Gene_Sets/Fin_GTEx_WholeBlood.txt")
dim(seg_gtex)
```
