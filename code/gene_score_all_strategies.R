...
score_file = "/n/groups/price/kushal/Robocov/data/Gene_Scores/Corspan_mean.txt"
annotation_folder = "Corspan_mean"
bed_cell = "/n/groups/price/kushal/Robocov/data/BEDFILES"
bed_folder = "Corspan_mean"
...
write.table(temp2, file = paste0(bed_cell, "/", bed_folder, "/", "5kb.bed"),
