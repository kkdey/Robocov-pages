library(data.table)
library(rmeta)
annot_cell = "/n/groups/price/kushal/Mouse_Humans/data/ANNOTATIONS/GENE_SCORES/Pi_grades"
results_cell = "/n/groups/price/kushal/Mouse_Humans/data/LDSC_RESULTS/GENE_SCORES/Pi_grades/baselineLD_v2.1_S2G_Aug14"
