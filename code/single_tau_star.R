...
out2 = run_single_tau_analysis(annot_cell, results_cell, annotations = annot_names, traits = brain_traits,
                                index_in_results = annot_idx, flag = 0)
out3 = run_single_tau_analysis(annot_cell, results_cell, annotations = annot_names,
                                traits = c(blood_traits, autoimmune_traits),
                                index_in_results = annot_idx, flag = 0)
out4 = run_single_tau_analysis(annot_cell, results_cell, annotations = annot_names,
